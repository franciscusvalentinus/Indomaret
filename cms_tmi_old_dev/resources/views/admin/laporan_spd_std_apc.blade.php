...
@section('content')
    ...
    <div class="modal fade-scale" id="custom_loader" role="dialog">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <label class="col-md-2 control-label">Pilih Bulan Mulai</label>
                                <label class="col-md-2 control-label">Pilih Bulan Akhir</label>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
...
{{--                                    </select>--}}
                    ...
                    <form id="exportform" action="export_spd_std_apc" method="post" target="_blank">
