            ...
            <div class="panel panel-default flat">
                <div class="panel-body project-team">
                    <div class="task-progress">
                        <h1>Upload File Master Margin</h1>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{ url('uploadmaxhargacontroller') }}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        {{--<div class="form-group" style="margin-left: 0px;">--}}
                        {{--<div class="col-md-12" style="padding-left: 0px;">--}}
                        {{--<label style="font-size: large !important;" class="control-label">Pilih Member TMI </label><i style="color: red"> *</i>--}}
                        {{--</div>--}}
                        {{--<div class="col-md-12" style="padding-left: 0px;">--}}
...
{{--                                    {!! $branch !!}--}}
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                            <span>
                            Gunakan Fitur ini untuk melakukan proses upload master margin Max<br />
