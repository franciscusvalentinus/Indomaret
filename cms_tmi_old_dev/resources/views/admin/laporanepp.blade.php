                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <label class="col-md-3 control-label" style="visibility: gone;"> </label>
...
{{--                                        <option style='font-size: 12px;' value='tanggal'>PER TANGGAL</option>--}}
                                ...
                                <div class="col-md-3" style="text-align:center;">
                                    <button class="col-md-3 btn btn-primary" type="button" onclick="downloadEppData()" style="width: 100%">SUBMIT
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        function downloadEppData(){
            var cabang = $('#scopecabang').val();
            var bulan = $('#scopebulan').val();
            var tahun = $('#scopetahun').val();
            /*if(cabang == '%'){
                alert('cabang harus di pilih!');
                return;
            }*/
            if(bulan == '%-%'){
                alert('bulan harus di pilih!');
                return;
            }
            if(tahun == '%'){
            ...
            console.log(cabang + ' | ' + bulan + ' | ' + tahun);
            $.ajax({
                url:'export_epp_file',
                type : 'POST',
                data : {
